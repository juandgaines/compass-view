...
class CompassView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in Directions.values()) {
            ...
            canvas.drawText(label, pointPosition.x, pointPosition.y+17, paintText)
        }
    ...
    private fun drawCursor(canvas:Canvas, paint:Paint, widthT:Int ){
        ...
        val pointCursor=PointF((width / 2.0f),(height/2.0f).minus(radius).minus(CURSOR_OFFSET_INDICATOR))
